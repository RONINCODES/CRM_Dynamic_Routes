...
get '/contacts/:id' do
  @contact = Contact.find(params[:id].to_i) #params[:id] contains the id from the url.
  if @contact
  erb :show_contact # instructions for how to handle requests to this route will go here
  else
